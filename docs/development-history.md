...
The project has already practiced:
...
Current repository intentionally keeps runtime secrets, databases, Python environments, and backup files outside Git.
...
This prevents credentials, runtime data, and development backups from being committed.
